...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).color(DEFAULT_COLOR).price(DEFAULT_PRICE).numberOfPages(DEFAULT_NUMBER_OF_PAGES);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).color(UPDATED_COLOR).price(UPDATED_PRICE).numberOfPages(UPDATED_NUMBER_OF_PAGES);
        return book;
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).color(UPDATED_COLOR).price(UPDATED_PRICE).numberOfPages(UPDATED_NUMBER_OF_PAGES);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).color(UPDATED_COLOR).price(UPDATED_PRICE).numberOfPages(UPDATED_NUMBER_OF_PAGES);
