...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).color(DEFAULT_COLOR).price(DEFAULT_PRICE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).color(UPDATED_COLOR).price(UPDATED_PRICE);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getColor()).isEqualTo(DEFAULT_COLOR);
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).color(UPDATED_COLOR).price(UPDATED_PRICE);
        ...
        assertThat(testBook.getColor()).isEqualTo(UPDATED_COLOR);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).color(UPDATED_COLOR).price(UPDATED_PRICE);
