...
class PublisherResourceIT {
    ...
    public static Publisher createEntity(EntityManager em) {
        Publisher publisher = new Publisher().name(DEFAULT_NAME).address(DEFAULT_ADDRESS);
        return publisher;
    }
    ...
    public static Publisher createUpdatedEntity(EntityManager em) {
        Publisher publisher = new Publisher().name(UPDATED_NAME).address(UPDATED_ADDRESS);
        return publisher;
    }
    ...
    void putNewPublisher() throws Exception {
        ...
        updatedPublisher.name(UPDATED_NAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdatePublisherWithPatch() throws Exception {
        ...
        partialUpdatedPublisher.name(UPDATED_NAME).address(UPDATED_ADDRESS);
